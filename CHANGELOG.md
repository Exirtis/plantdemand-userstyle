...
<!-- Optionally add compare links once you tag releases:
[1.0.9]: https://github.com/Exirtis/plantdemand-userstyle/compare/v1.0.8...v1.0.9
[1.0.8]: https://github.com/Exirtis/plantdemand-userstyle/compare/v1.0.7...v1.0.8
... -->
...
## Planned / Unreleased
- Harden selectors for **Material** grouping mode (Schedule view).
- Evaluate `data-*` / ARIA attributes to reduce dependency on hashed CSS module classes.
